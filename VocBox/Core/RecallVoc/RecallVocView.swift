...
struct RecallVocView: View {
    ...
    var body: some View {
        ...
        VStack{
            GeometryReader { proxy in
                VStack(alignment: .leading) {
                   ...
                   // Spacer()
                    ...
                    Button {
                        ...
                        CrashManager.shared.addLog(message: "tapped submit")
                ...
                .alert("Congratulations!",
                    ...
                    Button("Ok") {
                        CrashManager.shared.addLog(message: "tapped on ok button in 100% score alert")
                        dismiss()
                ...
                .toolbar {
                    Button {
                        CrashManager.shared.addLog(message: "tapped on quit button")
                        ...
                        .alert("Better luck next time!",
                            ...
                            Button("Ok") {
                                CrashManager.shared.addLog(message: "tapped on ok button in better luck alert")
                                dismiss()
                            }
                            .onDisappear {
                                //checking if we can show review prompt
                ...
                .toolbar {
                    Button {
                        CrashManager.shared.addLog(message: "tapped on hint button")
                        //show a hint on UI
        ...
        .onAppear {
            CrashManager.shared.addLog(message: "recall voc view(challenge) appeared on user's screen")
        }
    }
