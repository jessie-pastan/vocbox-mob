        ...
        VStack{
            GeometryReader { proxy in
                VStack(alignment: .leading) {
                    ...
                    .onTapGesture {
                        CrashManager.shared.addLog(message: "tapped on edit word textfield")
                    }
                    .frame(height: 20)
                    ...
                    .onTapGesture {
                        CrashManager.shared.addLog(message: "tapped on edit definition textfield")
                    }
                    .frame(height: 40)
                    .padding(10)
                    .padding(.top, 15)
                    ...
                    Button {
                        ...
                        CrashManager.shared.addLog(message: "tapped on save button to save edited word")
         ...
         .onAppear {
           CrashManager.shared.addLog(message: "Edit voc view appeared on user's screen")
         }
    }
